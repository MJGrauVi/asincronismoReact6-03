...
const PeliculaDetalle = ({ film }) => {
  ...
  useEffect(() => {
    if (!film) return;//Todavía no se ha seleccionado una película.
    //Si no hay película seleccionada no reacciona.
  ...
  //Si no hay pelicula seleccionada informamos al usuario.
